        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    playtime_hours = table.Column<int>(type: "integer", nullable: false),
                    playtime_player_count = table.Column<int>(type: "integer", nullable: false),
                    game_details_genre = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    game_details_platform = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    game_details_tags = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    game_details_game_mode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    game_details_distribution_format = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
